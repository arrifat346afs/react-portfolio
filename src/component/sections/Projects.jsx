      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <div className="p-6 rounded-xl border border-white/20 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
              ...
              <div className="flex flex-wrap gap-2 mb-4 mt-6">
                {["React", "Node.js", "AWS", "Docker"].map((tech, key) => (
                  <span
                    key={key}
                    className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm cursor-pointer hover:-translate-y-0.5 hover:bg-blue-500/20 
            ...
            <div
              className="
              glass p-6 rounded-xl border border-white/20 
